...
* Modified by: John Pilon & Danie Brenot
*/
...
#define PLATY_INT_MAX 32767/*Cant use short max, as it is processor dependant*/
#define PLATY_INT_MIN -32768
...
int  st_table[][TABLE_COLUMNS] = {
	...
	/* State 7  */	{ 8, 7, ES, 8, 7, 8, 8, 8 },
	/* State 8  */	{ IS, IS, IS, IS, IS, IS, IS, IS },
	/* State 9  */	{ ES, 11, ES, 11, 11, ES, ES, ESWR},
